...
```{r}
outbreak <- import("~/PHW253_2022/PH W253 Descriptive Epi Assignment line list_redacted.xlsx")
names(outbreak)
head(outbreak)
```
...
## can use case_when instead too
outbreakA$Region<-ifelse(outbreakA$State=="CT" |
                        outbreakA$State=="MA" |
                        outbreakA$State=="ME" |
                        outbreakA$State=="NH" |
                        outbreakA$State=="NJ" |
                        ...
                        outbreakA$State=="PA" |
                        outbreakA$State=="RI" |
                        outbreakA$State=="VT", "Region I. Northeast",NA) 

outbreakA$Region<-ifelse(outbreakA$State=="IA" |
                          outbreakA$State=="IL" |
                          outbreakA$State=="IN" |
                          outbreakA$State=="KS" |
                          outbreakA$State=="MI" |
                          ...
                          outbreakA$State=="OH" |
                          outbreakA$State=="SD" |
                          outbreakA$State=="WI" , "Region II. Midwest",outbreakA$Region)

outbreakA$Region<-ifelse(outbreakA$State=="AL" |
                           outbreakA$State=="AR" |
                           outbreakA$State=="DE" |
                           outbreakA$State=="DC" |
                           outbreakA$State=="FL" |
                           ...
                           outbreakA$State=="TX" |
                           outbreakA$State=="VA" |
                           outbreakA$State=="WV" , "Region III. South",outbreakA$Region)

outbreakA$Region<-ifelse(outbreakA$State=="AK" |
                           outbreakA$State=="AZ" | 
                           outbreakA$State=="CA" |
                           outbreakA$State=="CO" |
                           outbreakA$State=="HI" |
                           ...
                           outbreakA$State=="UT" |
                           outbreakA$State=="WA" |
                           outbreakA$State=="WY" , "Region IV. West",outbreakA$Region)

## new variable Region is a character variable
table(outbreakA$Region, exclude=NULL)

## cross-tabulation to check variable re-code 
## need package janitor to run this code
outbreakA %>% tabyl(State, Region)
# alternative code using table
table(outbreakA$State, outbreakA$Region, exclude=NULL)
```
